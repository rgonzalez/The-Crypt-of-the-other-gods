...
public class RFX4_PhysicsMotion : MonoBehaviour
{
    ...
    public bool canExplode = true; //this system determines if the bullet can explode or is bouncing
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        foreach (ContactPoint contact in collision.contacts)
        {
            ...
            if (handler != null)
                handler(this, new RFX4_CollisionInfo { HitPoint = contact.point, HitCollider = contact.otherCollider, HitGameObject = contact.otherCollider.gameObject, Collision = collision});
